...
<?php $component->withAttributes(['title' => 'Welcome!']); ?>
    ...
    <div>
        <h1>
            <?php echo e($idea->state); ?>-<?php echo e($idea->description); ?>
    ...
    <a href="/ideas/<?php echo e($idea->id); ?>/edit">Edit</a>
    <button type="submit" form="delete-idea-form">Delete</button>

    <form id="delete-idea-form" method="POST" action="/idea/<?php echo e($idea->id); ?>">
    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Crissaunt\Documents\GitHub\laravel-project\resources\views/ideas/show.blade.php ENDPATH**/ ?>