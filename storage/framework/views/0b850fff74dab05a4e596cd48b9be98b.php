...
<?php $component->withAttributes(['title' => 'Welcome!']); ?>
    ...
    <ul>
        <?php $__currentLoopData = $ideas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li><?php echo e($idea->description); ?> - <?php echo e($idea->state); ?> <a href="/idea/<?php echo e($idea->id); ?>">show</a></li>
...
<?php endif; ?>
<?php /**PATH C:\Users\Crissaunt\Documents\GitHub\laravel-project\resources\views/ideas/index.blade.php ENDPATH**/ ?>