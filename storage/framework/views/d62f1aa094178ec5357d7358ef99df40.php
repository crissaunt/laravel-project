...
<?php $component->withAttributes(['title' => 'Welcome!']); ?>
    ...
    <form method="POST" action="/ideas/<?php echo e($idea->id); ?>">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PATCH'); ?>
            <label for="description">new description</label>
        <textarea name="description" id="description" rows="10" cols="30"><?php echo e($idea->description); ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\Users\Crissaunt\Documents\GitHub\laravel-project\resources\views/ideas/edit.blade.php ENDPATH**/ ?>